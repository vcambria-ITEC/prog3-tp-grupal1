...
import { getMovies, getShows } from "@/lib/data"; 

export default function FavoritesPage() {
  const allMedia = [...getMovies(), ...getShows()];
  
  const favoriteIds = ["1", "3", "5", "8"]; // Replace with whatever IDs exist in your mock data
  const favorites = allMedia.filter(media => favoriteIds.includes(media.id));
